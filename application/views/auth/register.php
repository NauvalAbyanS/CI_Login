  <div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5 mx col-md-7 mx-auto">
              ...
              <form class="user" method="post" action="<?= base_url('auth/register'); ?>">
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" name="name" class="form-control form-control-user form-rounded" id="exampleFirstName" placeholder="Full Name">
